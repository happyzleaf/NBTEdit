                ...
                public void run() {
                    ...
                    if (te != null) {
                        ...
                        NBTEdit.proxy.sendMessage(player, "Error - There is no TileEntity at "
                                + pos.getX() + ", " + pos.getY() + ", " + pos.getZ(), EnumChatFormatting.RED);
                    }
                }
            });
        }
            ...
            player.getServerForPlayer().addScheduledTask(new Runnable() {
                ...
                public void run() {
                    ...
                    if (entity instanceof EntityPlayer && entity != player) {
                        NBTEdit.proxy.sendMessage(player, "Error - You may not use NBTEdit on other Players", EnumChatFormatting.RED);
                    ...
                    if (entity != null) {
                        ...
                        NBTEdit.proxy.sendMessage(player, "\"Error - Unknown EntityID #" + entityId, EnumChatFormatting.RED);
                    }
                }
            });
        }
